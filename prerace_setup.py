...
def unpack_round_settings(curr_round: int, rounds: dict):
    round_settings = rounds[curr_round]
    return round_settings[RACERS], round_settings[TRACK_LENGTH]


def _build_round(curr_round, i, race_settings: dict, racers, rounds):
...
def _build_round_racers(curr_round: int, race_settings: dict):
